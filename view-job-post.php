          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <p><a href="http://localhost/project/login-candidates.php" class="btn btn-primary btn-flat" role="button">Apply Now</a>
                <hr>
                <div class="row">
                  <div class="col-md-4"><a href="http://localhost/project/login-candidates.php"></i></a></div>
